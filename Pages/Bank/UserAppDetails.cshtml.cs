...
namespace EMedicalClaimRefundSystem.Pages.Bank
{
    ...
    public class UserAppDetailsModel : PageModel
    {
        ...
        {
            UserAppService.UpdateStatusAsync(UserAppViewModel.Id, Convert.ToInt32(ApplicationStatus.RefundedSucessfully));
            return LocalRedirect("~/SucessfullChangesPop");
        }
        public IActionResult OnPostRejected(UserApplicationViewModel UserAppViewModel)
        {
            UserAppService.UpdateStatusAsync(UserAppViewModel.Id, Convert.ToInt32(ApplicationStatus.BankRejected));
            return LocalRedirect("~/SucessfullChangesPop");
        }
    }
}